  ...
  for (let i = 0; i < spineList.length; i++) {
    ...
    xhr.onload = function() {
      ...
      if (i === 0) {
        ...
        $("link[href=\"../Styles/stylesheet.css\"]").replaceWith('<link rel="stylesheet" href="../../css/style/DoHoaiNamStyle-ebpaj_fonts_patch.css">\n<link rel="stylesheet" href="../../css/style/DoHoaiNamStyle-before.css">\n' + $("link[href=\"../Styles/stylesheet.css\"]").prop('outerHTML').replace('..', volume.concat('/OEBPS')) + '\n<link rel="stylesheet" href="../../css/style/DoHoaiNamStyle-after.css">');
      }
