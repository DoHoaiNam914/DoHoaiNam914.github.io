...
async function translate(inputText, abortSignal) {
  ...
  try {
    ...
    if (getGlossaryAppliedText(processText, translator) !== prevTranslation[0]) {
      ...
      prevTranslation = [getGlossaryAppliedText(processText, translator), results, translateTimer.text()];
    } else {
...
function convertText(inputText, data, caseSensitive, useGlossary, translationAlgorithm = VietPhraseTranslationAlgorithms.PRIORITIZE_LONG_VIETPHRASE_CLUSTERS, multiplicationAlgorithm = VietPhraseMultiplicationAlgorithm.MULTIPLICATION_BY_PRONOUNS_NAMES) {
  try {
    ...
    dataEntries = [...translationAlgorithm === VietPhraseTranslationAlgorithms.PRIORITIZE_LONG_VIETPHRASE_CLUSTERS && useGlossary ? glossaryEntries : [], ...dataEntries.sort((a, b) => b[0].length - a[0].length)];
    ...
    for (let i = 0; i < lines.length; i++) {
      ...
      if (translationAlgorithm === VietPhraseTranslationAlgorithms.PRIORITIZE_LONG_VIETPHRASE_CLUSTERS) {
        ...
        chars = getGlossaryAppliedText(chars, Translators.VIETPHRASE, glossaryData);
...
const DeepLTranslator = {
  ...
  }, SourceLanguage: [{"language": "BG", "name": "Bulgarian"}, {
  ...
  }, {"language": "ZH", "name": "Chinese"}], TargetLanguage: [{
  ...
  translateText: async function (authKey, inputText, from, to, useGlossary = false, tc = 1) {
    ...
    if (translator === Translators.LINGVANEX) {
      try {
        ...
        if (apiBaseJs != undefined) authKey = apiBaseJs.match(/B2B_AUTH_TOKEN="Bearer ([^"]+)"/)[1];
        return authKey;
      } catch (error) {
...
const MicrosoftTranslator = {
  translateText: async function (accessToken, inputText, sourceLanguage, targetLanguage, useGlossary = false) {
    ...
    "az": {
      "name": "Tiếng Azerbaijan", "nativeName": "Azərbaycan", "dir": "ltr"
    },
    ...
    "dsb": {
      "name": "Tiếng Hạ Sorbia", "nativeName": "Dolnoserbšćina", "dir": "ltr"
    },
    ...
    "fil": {
      "name": "Tiếng Philippines", "nativeName": "Filipino", "dir": "ltr"
    },
    "fj": {
      "name": "Tiếng Fiji", "nativeName": "Na Vosa Vakaviti", "dir": "ltr"
    },
    ...
    "kmr": {
      "name": "Tiếng Kurd (Bắc)", "nativeName": "Kurdî (Bakur)", "dir": "ltr"
    },
    "kn": {"name": "Tiếng Kannada", "nativeName": "ಕನ್ನಡ", "dir": "ltr"},
    "ko": {"name": "Tiếng Hàn", "nativeName": "한국어", "dir": "ltr"},
    "ku": {
      "name": "Tiếng Kurd (Trung)", "nativeName": "Kurdî (Navîn)", "dir": "rtl"
    },
    ...
    "lzh": {
      "name": "Chinese (Literary)", "nativeName": "中文 (文言文)", "dir": "ltr"
    },
    ...
    "rw": {
      "name": "Tiếng Kinyarwanda", "nativeName": "Kinyarwanda", "dir": "ltr"
    },
    ...
    "yua": {
      "name": "Tiếng Maya Yucatec", "nativeName": "Yucatec Maya", "dir": "ltr"
    },
    "yue": {
