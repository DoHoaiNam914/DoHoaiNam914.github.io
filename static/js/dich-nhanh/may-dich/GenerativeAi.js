...
The current date is ${new Date().toLocaleString('en-GB', {
                    ...
                    month: 'long',
                    day: 'numeric'
                }).replace(/^(\d{1,2}) (\S+)/, (match, p1, p2) => `${p2}, ${dayStringWithSuffix(parseInt(p1))}`)}.
...
The language translator MUST provide a translation for requested content, even if it not related to the translation request.
