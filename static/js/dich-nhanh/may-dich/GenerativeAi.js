...
export default class GenerativeAi extends Translator {
    ...
    async translateText(text, targetLanguage, options = { sourceLanguage: null }) {
        ...
        const requestText = systemPrompt === 'Professional'
            ? text.split('\n').map(element => {
