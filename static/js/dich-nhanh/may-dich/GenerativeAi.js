    ...
    async translateText(text, targetLanguage, options = { sourceLanguage: null }) {
        ...
        switch (systemPrompt) {
            case 'Advanced': {
                ...
                const originalLang = targetLanguage === 'English' ? sourceLanguage.toUpperCase() : sourceLanguage;
                const destLang = targetLanguage === 'English' ? targetLanguage.toUpperCase() : targetLanguage;
                const DOMAIN_MAP = {
