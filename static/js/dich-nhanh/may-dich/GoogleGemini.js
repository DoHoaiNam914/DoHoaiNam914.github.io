        ...
        data: JSON.stringify({
          contents: [
            ...
            },
            {
              ...
              parts: [
                {
                  text: `Please provide the text you would like to have translated into ${targetLanguage} within the ORIGINAL TEXT.`,
                },
              ],
            },
            {
...
\`\`\`tsv
source\ttarget
${terminologies.length > 0 ? names.map((element) => element.join('\t')).join('\n') : '...'}
\`\`\`
ORIGINAL TEXT:
\`\`\`txt
