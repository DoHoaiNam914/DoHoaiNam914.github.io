...
class Vietphrase {
  ...
  async translateText(__, targetLanguage, inputText, translationAlgorithm, multiplicationAlgorithm, prioritizeNameOverVietPhrase, addDeLeZhao, autocapitalize, data, nameEnabled, glossary = []) {
    ...
    this.data.hanViet = new Map(this.data.SinoVietnameses.map(([first, second]) => [first, second.toLowerCase()]).concat([
      ...
      ['泡', 'BÀO'],
      ['赑', 'BỊ'],
      [/* Không rõ */'㳎', null, 'biện'/* Đỗ Hoài Nam */],
      ['捕', 'BỔ'],
      ['怖', 'BỐ'],
      [/* Không rõ */'㳍', null, 'bố'/* Đỗ Hoài Nam */],
      [/* Không rõ */'侼', null, 'bột'/* Từ điển Hán Nôm */],
      ['咖', 'CA'],
      [/* Không rõ */'汵', null, 'cam, hàm'/* Từ điển Hán Nôm */],
      ['干', 'CAN'],
      ['赣', 'CÁN'],
      [/* Không rõ */'䀴', null, 'cảnh'/* Đỗ Hoài Nam (景) */],
      ['薅', 'CAO'],
      [/* Không rõ */'㹏', null, 'cẩn'/* Đỗ Hoài Nam */],
      [/* Không rõ */'䛗', null, 'chỉ'/* Đỗ Hoài Nam (止) */],
      ['正', 'CHÍNH'/* Họ */],
      ['政', 'CHÍNH'],
      ['锤', 'CHUỲ'],
      ['褚', 'CHỬ'/* Họ */],
      ['骷', 'CÔ'],
      [/* Không rõ */'㣉', null, 'công'/* Từ điển Hán Nôm */],
      ['机', 'CƠ'],
      ['玑', 'CƠ'],
      ...
      ['缘', 'DUYÊN'],
      ['兖', 'DUYỄN'],
      [/* Không rõ */'䯬', null, 'đả'/* Từ điển Hán Nôm */],
      [/* Không rõ */'䜥', null, 'đản'/* Từ điển Hán Nôm */],
      ['台', 'ĐÀI'/* Họ */],
      ['抬', 'ĐÀI'],
      [/* Không rõ */'丼', null, 'đảm | tỉnh'/* Hanzii */],
      ['娣', 'ĐỆ'],
      ['侄', 'ĐIỆT'],
      ['顶', 'ĐỈNH'],
      ['锻', 'ĐOÀN'],
      [/* Không rõ */'姛', null, 'đồng'/* Đỗ Hoài Nam */],
      ['洞', 'ĐỘNG'],
      ['郝', 'HÁCH'/* Họ */],
      [/* Không rõ */'䃢', null, 'hâm, khâm'/* Từ điển Hán Nôm */],
      ['唏', 'HI'],
      ['屃', 'HÍ'],
      ['峡', 'HIỆP'],
      ...
      ['绮', 'KHỞI'],
      ['其', 'KI, KỲ', 'KỲ'],
      [/* Không rõ */'䭼', null, 'kì, kỳ'/* Từ điển Hán Nôm */],
      ['劲', 'KÌNH'],
      ['期', 'KỲ'],
      ['祁', 'KỲ'],
      ['岐', 'KỲ'],
      ...
      ['骑', 'KỴ'],
      ['铝', 'LÃ'],
      [/* Không rõ */'菈', null, 'lạp'/* Đỗ Hoài Nam */],
      ['辇', 'LIÊN'],
      ['仑', 'LUÂN'],
      ['胧', 'LUNG'],
      ['拢', 'LŨNG'],
      ...
      ['璃', '', 'ly | li | lê'/* Hanzii */],
      ['妈', 'MA'],
      [/* Không rõ */'嫲', null, 'ma'/* Đỗ Hoài Nam */],
      ['玫', 'MAI'],
      ['曼', 'MAN'],
      ['牦', 'MAO'],
      ['咩', 'MIẾT'],
      ['茗', 'MINH'],
      [/* Không rõ */'䯮', null, 'năng'/* Đỗ Hoài Nam (能) */],
      ['闹', 'NÁO'],
      ['嚣', 'NGAO'],
      ['垠', 'NGẦN'],
      ['荛', 'NGHIÊU'],
      ...
      ['刃', 'NHẪN'],
      ['儿', 'NHI'],
      [/* Không rõ */'蒅', null, 'nhiễm'/* Đỗ Hoài Nam */],
      ['聂', 'NHIẾP'/* Họ */],
      [/* Không rõ */'㹓', null, 'nhiêu, nhiễu, liểu'/* Đỗ Hoài Nam (嬈) */],
      [/* Không rõ */'奻', null, 'nhu'/* Đỗ Hoài Nam (濡) */],
      ['蕊', 'NHUỴ'],
      ['袅', 'NIỄU'],
      ['宁', 'NINH'/* Họ Ninh */],
      [/* Phổn thể */'苧', 'NINH'],
      ['柠', 'NINH'],
      ['樊', 'PHÀN'/* Họ */],
      [/* Không rõ */'䭻', null, 'phận, phận, phần'/* Đỗ Hoài Nam */],
      ['缚', 'PHỌC'],
      ['浦', 'PHỐ'/* Họ */],
      ['仆', 'PHỐC, BỘC'],
      [/* Không rõ */'㰴', null, 'phủ'/* Đỗ Hoài Nam */],
      ['绾', 'QUÁN'],
      ['广', 'QUẢNG'],
      ['瑰', 'QUẾ, KHÔI', 'KHÔI'],
      [/* Không rõ */'㵕', null, 'sấm'/* Từ điển Hán Nôm */],
      ...
      ['帅', 'SOÁI'/* Họ */],
      ['山', 'SƠN'/* Họ */],
      [/* Không rõ */'㦳', null, 'tài'/* Từ điển Hán Nôm */],
      ['噻', 'TẮC'],
      ['噌', 'TĂNG'],
      ['沁', 'TẨM'],
      ['烬', 'TẦN'],
      ...
      ['沈', 'THẨM'/* Họ */],
      ['单', 'THIỀN, ĐƠN', 'ĐƠN'],
      [/* Không rõ */'墥', null, 'thoản'/* Từ điển Hán Nôm */],
      ['兔', 'THỐ'],
      ['姝', 'THÙ'],
      ['驯', 'THUẦN'],
      ['属', 'THUỘC'],
      ...
      ['璇', 'TOÀN'],
      [/* Không rõ */'㹐', null, 'trùng'/* Đỗ Hoài Nam */],
      ['橙', 'TRÀNH, TRANH, ĐẮNG', 'TRANH'],
      ['沼', 'TRẢO'],
      [/* Không rõ */'治', null, 'trị | trì'/* Hanzii */],
      ['镯', 'TRỌC'],
      ['住', 'TRÚ'],
      ['着', 'TRƯỚC, CHIÊU'],
      ['场', 'TRƯỜNG'],
      ...
      ['碗', 'UYỂN'],
      ['哟', 'ƯỚC'],
      [/* Không rõ */'䗽', null, 'vị, dữu'/* Đỗ Hoài Nam (蜼) */],
      ['援', 'VIỆN'],
      ['眦', 'XẾ'],
      ['掣', 'XIẾT'],
      ['冲', 'XUNG'],
      ['夭', 'YỂU'],
    ].map(([a, b, c], ___, array) => [a, (Object.fromEntries(array.filter(([____, d]) => !/\p{Script=Hani}/u.test(d)).map(([d, e, f]) => [d, f ?? e]))[b] ?? c ?? b).split(/, | \| /)[0].toLowerCase()]), this.data.hanViet).filter(([first], ___, array) => !array[first] && (array[first] = 1), {}));
