...
class Vietphrase {
  ...
  async translateText(__, targetLanguage, inputText, translationAlgorithm, multiplicationAlgorithm, prioritizeNameOverVietPhrase, addDeLeZhao, autocapitalize, data, nameEnabled, glossary = []) {
    ...
    this.data.hanViet = new Map(this.data.SinoVietnameses.map(([first, second]) => [first, second.toLowerCase()]).concat([
      ...
      ['捕', 'BỔ'],
      ['怖', 'BỐ'],
      [/* Không rõ */'㳍', null, 'bố'/* Đỗ Hoài Nam (布) */],
      ...
      ['赣', 'CÁN'],
      ['薅', 'CAO'],
      [/* Không rõ */'㹏', null, 'cẩn'/* Đỗ Hoài Nam (堇) */],
      ['正', 'CHÍNH'/* Họ */],
      ['政', 'CHÍNH'],
      ['锤', 'CHUỲ'],
      ['褚', 'CHỬ'/* Họ */],
      ...
      ['顶', 'ĐỈNH'],
      ['锻', 'ĐOÀN'],
      [/* Không rõ */'姛', null, 'đồng'/* Đỗ Hoài Nam (同) */],
      ['洞', 'ĐỘNG'],
      ['郝', 'HÁCH'/* Họ */],
      ...
      ['骑', 'KỴ'],
      ['铝', 'LÃ'],
      [/* Không rõ */'菈', null, 'lạp'/* Đỗ Hoài Nam (拉) */],
      ['辇', 'LIÊN'],
      ['仑', 'LUÂN'],
      ['胧', 'LUNG'],
      ['拢', 'LŨNG'],
      ...
      ['璃', '', 'ly | li | lê'/* Hanzii */],
      ['妈', 'MA'],
      [/* Không rõ */'嫲', null, 'ma'/* Đỗ Hoài Nam (麻) */],
      ['玫', 'MAI'],
      ['曼', 'MAN'],
      ['牦', 'MAO'],
      ['咩', 'MIẾT'],
      ...
      ['刃', 'NHẪN'],
      ['儿', 'NHI'],
      [/* Không rõ */'蒅', null, 'nhiễm'/* Đỗ Hoài Nam (染) */],
      ['聂', 'NHIẾP'/* Họ */],
      ['蕊', 'NHUỴ'],
      ['袅', 'NIỄU'],
      ['宁', 'NINH'/* Họ Ninh */],
      ...
      ['浦', 'PHỐ'/* Họ */],
      ['仆', 'PHỐC, BỘC'],
      [/* Không rõ */'㰴', null, 'phủ'/* Đỗ Hoài Nam (咅) */],
      ['绾', 'QUÁN'],
      ['广', 'QUẢNG'],
      ['瑰', 'QUẾ, KHÔI', 'KHÔI'],
      ...
      ['璇', 'TOÀN'],
      [/* Không rõ */'㹐', null, 'trùng'/* Đỗ Hoài Nam (虫) */],
