          ...
          contents: [
            {
              ...
              parts: [
                {
                  text: 'Translate the text in #original-text tag into Vietnamese. Do not skip the title. Remember to use the names listed under the #name-dictionary tag and the terms from the #glossary tag if available to enhance the accuracy of translation. When transliterating Japanese names, employ Hepburn Romanization, and for Chinese names, utilize Sino-Vietnamese. Make sure to reference the raw translation in #raw-translation for accuracy and consistency. Your translations must convey all the content in the original text in #original-text and cannot involve explanations or other unnecessary information. Please ensure that the translated text is natural for native speakers with correct grammar and proper word choices. Your output must only contain the translated text and cannot include explanations or other information.',
                },
              ],
            },
            {
