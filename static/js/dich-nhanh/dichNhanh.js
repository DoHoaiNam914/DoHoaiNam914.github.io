          ...
          contents: [
            {
              ...
              parts: [
                {
                  text: `Translate the text in the VĂN BẢN GỐC section into Vietnamese. Check, cross-reference, and correct any sentences or lines in the raw translation in the BẢN DỊCH THÔ section that may be misaligned or missing content before consulting it. Refer to the corrected raw translation line by line to ensure consistency in your translation. ${terminologies.length > 0 || names.length > 0 ? `Prioritize applying ${terminologies.length > 0 ? 'the terms listed in the BẢNG TRA CỨU THUẬT NGỮ section ' : ''}${names.length > 0 ? `${terminologies.length > 0 ? 'and ' : ''}the proper names listed in the BẢNG TRA CỨU TÊN RIÊNG section ` : ''}over anything else to enhance the accuracy and consistency of the translation. ` : ''}Your translations must convey all the content in the original text and cannot involve explanations or other unnecessary information. Please ensure that the translated text is natural for native speakers with correct grammar and proper word choices. Your output must only contain the translated text and cannot include explanations or other information.`,
                },
              ],
            },
            {
